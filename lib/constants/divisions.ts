...
export function findCategory(
  ...
  return categories.find(cat => {
    ...
    const hasHeightLimit = (cat.minHeight !== undefined && cat.minHeight !== null) || (cat.maxHeight !== undefined && cat.maxHeight !== null)
    if (hasHeightLimit) {
    ...
    const hasWeightLimit = (cat.minWeight !== undefined && cat.minWeight !== null) || (cat.maxWeight !== undefined && cat.maxWeight !== null)
    if (hasWeightLimit) {
