...
export function EnhancedSignUpFormFixed({
  className,
  ...props
        ...
        try {
          ...
          if (profileError) {
            ...
            if (profileError.message.includes('relation "profiles" does not exist')) {
              setError("Database setup incomplete. Please run the database schema setup first.");
              setIsLoading(false);
              return;
            }
          }

          // If the user is a coach, try to create a team
          ...
          setError("Account created but profile setup failed. You can complete your profile after signing in.");
        }
      }
