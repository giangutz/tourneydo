      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
            The Old Way is <span className="text-red-600 line-through decoration-4 decoration-red-200">Broken</span>
          </h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-12 md:gap-8 max-w-5xl mx-auto relative">
          ...
          <div className="hidden md:block absolute top-12 left-20 right-20 h-0.5 bg-gradient-to-r from-transparent via-slate-200 to-transparent -z-10" />

          {problems.map((problem, index) => (
            <div key={index} className="flex flex-col items-center text-center max-w-xs group">
              <div className="w-24 h-24 bg-red-50 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-red-100">
                <problem.icon className="w-10 h-10 text-red-600" />
              </div>
