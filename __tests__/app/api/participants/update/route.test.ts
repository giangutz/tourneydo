 ...
 */
import { POST } from '@/app/api/participants/update/route'
...
const createRequest = (body: any) => {
  return new Request('http://localhost:3000/api/participants/update', {
    method: 'POST',
    headers: {
...
describe('API Route: /api/participants/update', () => {
  beforeEach(() => {
    setMockCoach()
